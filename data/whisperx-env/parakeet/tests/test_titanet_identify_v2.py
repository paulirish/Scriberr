...
class TestIdentifier(unittest.TestCase):
    ...
    def test_match_and_update_speaker(self, mock_sf, MockQdrantClient, MockNeMoModel, mock_getctime): # Added mock_getctime                             
        ...
        self.assertAlmostEqual(updated_point.vector[0] / np.linalg.norm(updated_point.vector), 0.1375 / np.linalg.norm([0.1375]*192), places=4)
    ...
    @patch('titanet_identify_v2.QdrantClient')                                                                                                          
    @patch('titanet_identify_v2.sf')                                                                                                                    
    def test_s_norm_logic(self, mock_sf, MockQdrantClient, MockNeMoModel, mock_getctime, mock_np_std, mock_np_mean): # Reorder args to match decorators
        mock_client = MockQdrantClient.return_value                                                                                                     
