<<<<<<< HEAD:data/whisperx-env/parakeet/titanet_manage.py
#!/usr/bin/env python3
"""
...
||||||| ec10c26:internal/transcription/adapters/py/nvidia/titanet_manage.py
...
>>>>>>> mine:internal/transcription/adapters/py/nvidia/titanet_manage.py